...
<div class="w3l-hero-headers-9">
  <div class="css-slider">
    ...
    <section class="slide slide-one">
      <div class="container">
        <div class="banner-text">
          <h3> Looking To Change Your Look Pass By And Let's Revamp Your Look</h3>
          <h4>Newlook Hair & Beauty Salon<br>
          </h4>

            <a href="book-appointment.php" class="btn logo-button top-margin">Book Appointment</a>
        </div>
      </div>
    ...
    <section class="slide slide-two">
      <div class="container">
        <div class="banner-text">
          <h3>High Quality Services At Affordable Prices</h3>
          <h4>Join Us And Walk Out Feeling Refreshed<br>
           </h4>
          <a href="book-appointment.php" class="btn logo-button top-margin">Book Appointment</a>
        </div>
      </div>
            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 color-2 ">
                            <div>
                            <h4 class=" ">Some Of Our Work</h4>
                            <p class="para ">Newlook Hair & Beauty Salon - Beauty Services</p>
                            <a href="about.php" class="action-button btn mt-md-4 mt-3">Read more</a>
                        </div>
                    </div>
                        <div class="column col-lg-4 col-md-6 col-sm-6 back-image  ">
                            <img src="assets/images/WhatsApp Image 2022-10-16 at 14.17.52.jpeg" alt="product" class="img-responsive ">
                        </div>
                        <div class="column col-lg-4 col-md-6 col-sm-6 back-image2 ">
                            <img src="assets/images/after.png" alt="product" class="img-responsive ">
                          </div>
                    </div>
                </div>
        </div>
	...
	<div class="team-single-main ">
		<div class="container">
				...
				<div class="column2 image-text">
					...
					<p class="para  text ">
						Best Beauty expert at your home and provides beauty salon at home. Home Salon provide well trained beauty professionals for beauty services at home including Facial, Clean Up, Hair Cuts, Waxing,Pedicure, Manicure, etc.</p>
						<a href="book-appointment.php" class="btn logo-button top-margin mt-4">Book Now</a>
				</div>
			</div>
		</div>
	</div>
