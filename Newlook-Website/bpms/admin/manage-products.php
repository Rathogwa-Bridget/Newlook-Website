...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Manage Prodcuts</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						<h4>Update Products:</h4>
						<table class="table table-bordered"> <thead> <tr> <th>#</th> <th>Product Name</th> <th>Product Price</th> <th>Creation Date</th><th>Action</th> </tr> </thead> <tbody>
<?php
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['ProductName'];?></td> <td><?php  echo $row['Cost'];?></td><td><?php  echo $row['CreationDate'];?></td> <td>
